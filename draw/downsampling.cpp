...
void Downsampling::Initialize() {
	...
	for (int i = 0; i < 5; i++) {
		downsampledTextures[i] = SDL_CreateTexture(renderer->gRenderer, SDL_PIXELFORMAT_RGBA8888, SDL_TEXTUREACCESS_TARGET, RENDERER_WIDTH * steps[i], RENDERER_HEIGHT * steps[i]);
